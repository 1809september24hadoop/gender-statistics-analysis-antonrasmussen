...
/**
 * PROBLEM #4: List the % of change in female employment from the year 2000. 
 * @author Anton Rasmussen
 *
 */

public class Problem4Mapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
	...
	public static final String INDICATOR = "SL.EMP.TOTL.SP.FE.ZS"; //Employment to population ratio, 15+, female (%) (modeled ILO estimate)"
